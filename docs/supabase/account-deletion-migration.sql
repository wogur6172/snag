...
begin
  ...
  where public.board_snags.owner_id = target_user_id;

  delete from public.board_drawings
  where public.board_drawings.owner_id = target_user_id;

  delete from public.board_reports
  where public.board_reports.reporter_id = target_user_id
     or public.board_reports.target_user_id = target_user_id;

  delete from public.board_member_bans
  where public.board_member_bans.user_id = target_user_id
     or public.board_member_bans.created_by = target_user_id;

  delete from public.board_members
  where public.board_members.user_id = target_user_id;
